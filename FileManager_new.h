...
private:
   ...
   // SD Card pin definitions (SDMMC 4-bit mode for ESP32-S3)
    // NOTE: Avoid GPIO45, GPIO46 (strapping pins with internal weak pulldown)
    // NOTE: Avoid GPIO26-32 (SPI flash), GPIO33-37 (octal flash/PSRAM if used)
    // NOTE: Avoid GPIO43, GPIO44 (UART0), GPIO19, GPIO20 (USB)
